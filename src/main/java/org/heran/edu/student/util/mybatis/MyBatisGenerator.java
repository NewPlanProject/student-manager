...
public class MyBatisGenerator {
    ...
    public static void main(String args[]){
        String[] parameters = {"buildPath=build",
                ...
                "domainPath=D:\\projects\\last-edu\\student-manager\\src\\main\\java\\org\\heran\\edu\\student\\domain",
                "mapperPath=D:\\projects\\last-edu\\student-manager\\src\\main\\resources\\mapper",
                "daoPackage=org.heran.edu.student.dao",
                "daoPath=D:\\projects\\last-edu\\student-manager\\src\\main\\java\\org\\heran\\edu\\student\\dao",
                "tableList=tb_student"};
        // 解析参数
