package org.heran.edu.student.util.json;
...
public abstract class BaseJSON implements JSONStreamAware, JSONAware {
	...
	static {
		int features = 0;
		features |= SerializerFeature.QuoteFieldNames
				.getMask();
		features |= SerializerFeature.SkipTransientField
				.getMask();
		features |= SerializerFeature.WriteEnumUsingToString
				.getMask();
		features |= SerializerFeature.SortField
				.getMask();
		// features |=
